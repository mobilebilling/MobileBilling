...
public class ContentAuthRunnable implements Runnable {
    private Handler mHandler;
    private String httpUrl;
    private String req;

    public ContentAuthRunnable(String httpUrl, Handler mHandler, String req) {
    ...
    @Override
    public void run() {
        String result = OkHttpClientRequest.get().SentRequest(httpUrl+"gwUserAuth.do", getCommit(req));
        try {
