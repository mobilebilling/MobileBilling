...
public class GetPhoneVerifyRunnable implements Runnable {
    private Handler mHandler;
    private String httpUrl;
    private String req;

    public GetPhoneVerifyRunnable(String httpUrl, Handler mHandler, String req) {
    ...
    @Override
    public void run() {
        String result = OkHttpClientRequest.get().SentRequest(httpUrl+"gwGetCheckCode.do", getCommit(req));
        try {
